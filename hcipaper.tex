...
\title{Cooperative Spaceship Rescue: A communicative Game for Interactive Floors}
...
\begin{abstract}
\vspace{1mm}
After looking upon the possibilities of interactive floors and taking into account the immense demand for video games today, we developed \textit{Cooperative Spaceship Rescue} or \textit{CSR}. \textit{CSR} is designed as a fun prototype for communicative, interactive floor based games and demonstrates, how playing games at home can once again involve moving the entire body
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{walkthrough/totale2}
...
\section{Walkthrough}
\vspace{1mm}
In our sample scenario two users A and B want to play a game of \textit{Cooperative Spaceship Rescue} with the goal to reach the second Level. As the users enter the floor, they will start out in the \textit{Beaming Area}, as shown in figure?.
